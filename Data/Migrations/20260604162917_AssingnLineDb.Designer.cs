...
namespace Data.Migrations
{
    ...
    [Migration("20260604162917_AssingnLineDb")]
    partial class AssingnLineDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entites.EventSaver.LineDb", b =>
                {
                    b.HasOne("Data.Entites.EventSaver.SeasonDb", "Season")
                        .WithMany("Lines")
                        .HasForeignKey("SeasonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Users.Shared.Models.ApplicationUser", "Supervisor")
                        .WithMany()
